...
from teleop import __version__
from teleop.camera import AllCameras, get_all_cameras
from teleop.endpoints import (
    auth_router,
    camera_router,
    control_router,
    networking_router,
...
from teleop.hardware import simulation_init, simulation_stop
from teleop.models import ServerStatus
from teleop.posthog import posthog, posthog_pageview
from teleop.recorder import get_recorder
from teleop.robot import RobotConnectionManager, get_rcm
from teleop.teleoperation import UDPServer
from teleop.utils import get_dashboard_path, get_resources_path, login_to_hf
...
def init_telemetry() -> None:
    ...
    """
    from teleop.sentry import init_sentry
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        from teleop.endpoints.control import (
            ai_control_signal,
            gravity_control,
...
async def status(
    ...
    """
    from teleop.endpoints.control import ai_control_signal, leader_follower_control
