# type: ignore
## We don't enforce type hints in this file because it is a direct copy of the original file from the LeRobot repository.
...
import numpy as np
import tqdm
from teleop.hardware.motors.motor_utils import (
